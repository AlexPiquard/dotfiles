...
setw -g window-status-format "#[fg=#1e2030,bg=#1e2030,nobold,nounderscore,noitalics]#[default] #I  #W #F #{?@workmux_status, #{@workmux_status},} #[fg=#1e2030,bg=#1e2030,nobold,nounderscore,noitalics]"
setw -g window-status-current-format "#[fg=#1e2030,bg=#3b4261,nobold,nounderscore,noitalics]#[fg=#82aaff,bg=#3b4261,bold] #I  #W #F #{?@workmux_status, #{@workmux_status},} #[fg=#3b4261,bg=#1e2030,nobold,nounderscore,noitalics]"
